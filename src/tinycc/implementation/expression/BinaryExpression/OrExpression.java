...
public class OrExpression extends BinaryExpression {
    ...
    public OrExpression(Token operator, Expression left, Expression right) {
    ...
    public Formula toLogicalExpr() {
        return new BinaryOpFormula(BinaryOperator.OR, left.toBoolLogicalExpr(), right.toBoolLogicalExpr());
    }
}
